...
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)enterPictureInPictureModeForPlayer:(NSInteger)playerId error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)isPictureInPictureSupported:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)isInPictureInPictureModeForPlayer:(NSInteger)playerId error:(FlutterError *_Nullable *_Nonnull)error;
@end
