...
import 'package:video_player_avfoundation/src/messages.g.dart' as messages;
...
class _ApiLogger implements TestHostVideoPlayerApi {
  ...
  int? playerId;
  messages.CreationOptions? creationOptions;
  int? position;
  bool? looping;
  double? volume;
  ...
  @override
  int create(messages.CreationOptions options) {
    log.add('create');
  ...
  bool cancelDownload(String url) {
    log.add('cancelDownload');
    return false;
  }

  @override
  String? getCachedVideoPath(String url) {
    log.add('getCachedVideoPath');
    return null;
  }

  @override
  int getMaxConcurrentDownloads() {
    log.add('getMaxConcurrentDownloads');
    return 3;
  }

  @override
  bool removeDownload(String url) {
    log.add('removeDownload');
    return false;
  }

  @override
  String startDownload(String url) {
    log.add('startDownload');
    return '';
  }

  @override
  messages.DownloadProgress getDownloadProgress(String url) {
    log.add('getDownloadProgress');
  ...
  @override
  messages.DownloadState getDownloadState(String url) {
    // TODO: implement getDownloadState
    throw UnimplementedError();
  }
  
  @override
  bool enterPictureInPictureMode(int playerId) {
    // TODO: implement enterPictureInPictureMode
    throw UnimplementedError();
  }
  
  @override
  bool isInPictureInPictureMode(int playerId) {
    // TODO: implement isInPictureInPictureMode
    throw UnimplementedError();
  }
...
void main() {
  ...
  group('$AVFoundationVideoPlayer', () {
    ...
    test('createWithOptions with platform view on iOS', () async {
      ...
      expect(log.log.last, 'create');
      expect(log.creationOptions?.viewType,
          messages.PlatformVideoViewType.platformView);
      expect(playerId, 3);
    ...
    test('createWithOptions with platform view uses texture view on MacOS',
      ...
      expect(log.log.last, 'create');
      expect(log.creationOptions?.viewType,
          messages.PlatformVideoViewType.textureView);
      expect(playerId, 3);
      expect(player.playerViewStates[3],
          const VideoPlayerTextureViewState(textureId: 3));
    });
