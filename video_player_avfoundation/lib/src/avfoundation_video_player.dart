...
class AVFoundationVideoPlayer extends VideoPlayerPlatform {
  ...
  @override
  Future<bool> enterPictureInPictureMode(int playerId) async {
    return _api.enterPictureInPictureMode(playerId);
  }
  ...
  @override
  Future<bool> isInPictureInPictureMode(int playerId) async {
    return _api.isInPictureInPictureMode(playerId);
  }
