...
abstract class VideoPlayerPlatform extends PlatformInterface {
  ...
  Future<bool> enterPictureInPictureMode(int playerId) {
    throw UnimplementedError(
        'enterPictureInPictureMode() has not been implemented.');
  }
  ...
  Future<bool> isInPictureInPictureMode(int playerId) {
    throw UnimplementedError(
        'isInPictureInPictureMode() has not been implemented.');
  }
}
