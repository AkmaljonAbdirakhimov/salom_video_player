...
import 'android_video_cache_manager.dart';
...
class AndroidVideoPlayer extends VideoPlayerPlatform {
  ...
  static void registerWith() {
    ...
    VideoCacheApi.instance = AndroidVideoCacheManager.instance;
  }
  ...
  @override
  Future<bool> enterPictureInPictureMode(int textureId) async {
    return _api.enterPictureInPictureMode(textureId.toInt());
  }
  ...
  @override
  Future<bool> isInPictureInPictureMode(int textureId) async {
    return _api.isInPictureInPictureMode(textureId.toInt());
  }
